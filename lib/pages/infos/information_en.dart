                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                                children: [
                                                  Text("DECENTRALIZATION", style: TextStyle(color: appDarkColor, fontSize: 20, fontWeight: FontWeight.bold),),
                                                  SizedBox(height: 4,),
                                                  Text("The Decentralization journey in Rwanda was adopted in 2000. Over two decades later, progress has been realized in various areas...", textAlign: TextAlign.justify,style: TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                                children: [
                                                  Text("LAWS", style: TextStyle(color: appDarkColor, fontSize: 20, fontWeight: FontWeight.bold),),
                                                  SizedBox(height: 4,),
